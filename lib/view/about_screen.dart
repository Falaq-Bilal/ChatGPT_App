  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("About" , style:Themes.textStyle(color: Themes.white , fontSize: 18),),
      ),
      body: ListView(
        children: [
          ListTile(
            ...
            title: InkWell(child: Text("Help Center" , style: Themes.textStyle(color: Themes.white),), onTap: () async{
          ...
          SizedBox(height: 12,),
           ListTile(
            ...
            title: InkWell(child: Text("Terms of Use" , style: Themes.textStyle(color: Themes.white),), onTap: ()async{
          ...
          SizedBox(height: 12,),
           ListTile(
            ...
            title: InkWell(child: Text("Privacy Policy" , style: Themes.textStyle(color: Themes.white),), onTap: () async{
               final Uri url = Uri.parse("https://openai.com/en-GB/policies/privacy-policy/");
            await launchUrl(url); 
            },),
          ),
          SizedBox(height: 12,),
           ListTile(
            ...
            title: Text("Licenses" , style: Themes.textStyle(color: Themes.white),),
          ),
          SizedBox(height: 12,),
           ListTile(
            leading: CircleAvatar(
            ...
            title: Text("ChatGPT for Android" , style: Themes.textStyle(color: Themes.white),),
            subtitle: Text("1.2025.238(9)" , style: Themes.textStyle(color: Themes.white),),
          ),
        ],
      ),
    );

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text("Choose a voice"  , style: TextStyle(color: Themes.white)),
      ),
      body: Column( crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          ...
          SizedBox(height: 15,),
          Text("Breeze" , style: TextStyle(fontSize: 22 , fontWeight: FontWeight.bold , color: Themes.white),),
          SizedBox(height: 10,),
          Text("Animated and earnest" , style: TextStyle(fontSize: 17 , color: Themes.white),),
          Spacer(),
